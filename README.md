...
[![Go Reference](https://pkg.go.dev/badge/github.com/SirBerg/discordgo.svg)](https://pkg.go.dev/github.com/SirBerg/discordgo) [![Go Report Card](https://goreportcard.com/badge/github.com/SirBerg/discordgo)](https://goreportcard.com/report/github.com/SirBerg/discordgo) [![CI](https://github.com/SirBerg/discordgo/actions/workflows/ci.yml/badge.svg)](https://github.com/SirBerg/discordgo/actions/workflows/ci.yml) [![Discord Gophers](https://img.shields.io/badge/Discord%20Gophers-%23discordgo-blue.svg)](https://discord.gg/golang) [![Discord API](https://img.shields.io/badge/Discord%20API-%23go_discordgo-blue.svg)](https://discord.com/invite/discord-api)
...
```sh
go get github.com/SirBerg/discordgo
```
...
```go
import "github.com/SirBerg/discordgo"
```
...
- [![Go Reference](https://pkg.go.dev/badge/github.com/SirBerg/discordgo.svg)](https://pkg.go.dev/github.com/SirBerg/discordgo) 
...
- [DiscordGo Examples](https://github.com/SirBerg/discordgo/tree/master/examples) - A collection of example programs written with DiscordGo
- [Awesome DiscordGo](https://github.com/SirBerg/discordgo/wiki/Awesome-DiscordGo) - A curated list of high quality projects using DiscordGo

## Troubleshooting
For help with common problems please reference the 
[Troubleshooting](https://github.com/SirBerg/discordgo/wiki/Troubleshooting) 
